          ...
          <div class="usern"><b><font color="#fff"> Hello !!! <?php echo $user_data['username'];?></font></b></div>
            <div class="wrapper">
              <div class="left">
                  ...
                  <br>
                  <a href="BuserviewBus.php"><button class="btn4">Home </button></a>
              </div>
              </div>
...
<!--information-->
        <div class="right">
           ...
           <h3>Account Information</h3><hr/><br/>  
                ...
                <br><a href="BupdateProfile.php?id=<?php echo $user_data['id'];?>">
                <button class="btn3">Update</button></a>
                <a href="Buserlogout.php">
                <button class="btn3">Logout</button></a>
                <a href="BdeleteProfile.php?id=<?php echo $user_data['id'];?>">
