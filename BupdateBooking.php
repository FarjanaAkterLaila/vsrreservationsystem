...
<ul>
    ...
    <li><a href="BManagesBus.php">Manage Trains</a></li>
...
<!-------------------------------------------------->
   ...
   <?php 
     ...
     $seat=$_POST['booked_seat'];
       ...
       $query="UPDATE `booking` SET passenger_name='$passenger',telephone='$tel',email='$email',boarding_place='$board_place',Your_destination='$desti',booked_seat='$seat' where id=$id";
  ...
  <div class="registration_form">
    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        ...
        <div class="input_wrap">
          <label for="title">Booked Seat</label>
          <input type="number" id="title" name="booked_seat" class="idclass" placeholder="Seat" required>
        </div>
