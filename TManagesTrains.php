...
<html>
<head>
  <title>Admin Panel of Train</title>
  <!--cdn icon library -->
...
<div class="sidebar2">
		...
		<h1 class="adminTopic">Manage Trains</h1>
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="Tupdatetrain.php?id=<?php echo $row['id'];?>">
        ...
        <button style = "border:2px solid yellow; border-radius:7px; background-color:red;color:white;" >
          <a href="Tdeletetrain.php?id=<?php echo $row['id'];?>">
...
<br>
                       ...
                       <a href="TaddTrain.php">     <button class="btnPolicy">Add Train</button></a>
