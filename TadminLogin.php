...
<head>
    <meta charset="utf-8">
    <title>VSR Train Admin Login</title>
...
?>
    ...
    <div class="login-box">
        ...
        <form method="POST">
          ...
          <!--<a href="TsignUp.html" class="sign_up">sign up</a>&nbsp&nbsp&nbsp
    ...
    if(isset($_POST['login'])){
        ...
        $query="SELECT * FROM `tadmin` WHERE username='$_POST[Admin_username]'  AND  password='$_POST[Admin_password]'";
        ...
        // session_start();//
         ...
         window.location.href='TadminDash.php';
          ...
          echo '<script type="text/javascript">alert("incorrect_pass or username!!!")</script>';
        }
