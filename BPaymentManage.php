...
<?php
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:#8E44AD;color:white;">
          <a href="BupdateTransRecivied.php?id=<?php echo $row['id'];?>">
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="BdeleteTransRecivied.php?id=<?php echo $row['id'];?>">
