...
<ul>
    ...
    <li><a href="BManagesTrains.php">Manage Buses</a></li>
   ...
   <?php 
       ...
       $query="UPDATE `route` SET Via_city='$via_city',destination='$destination',bus_name='$bus_name',departure_date='$dep_date',departure_time='$dep_time',seat='$seat',cost='$cost' where id=$id";
