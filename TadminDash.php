...
<html>
<head>
  <title>Admin Panel of Train Services</title>
  <!--cdn icon library -->
...
<div class="sidebar2">
		...
		<h1 class="adminTopic">Manage Route of Trains</h1>
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:#9B59B6;color:white;">
          <a href="TupdateRoute.php?id=<?php echo $row['id'];?>">
        ...
        <button style = "border:2px solid yellow; border-radius:7px; background-color:#9B59B6;color:white;" >
          <a href="TdeleteRoute.php?id=<?php echo $row['id'];?>">
...
<br>
                       ...
                       <a href="TAddroute.php">     <button class="btnPolicy">Add Route</button></a>
