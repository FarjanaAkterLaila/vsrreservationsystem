     ...
     $amount=$_POST['amount'];
       ...
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt->bind_param("isssssissssi",$amount,$name,$email,$address,$city,$state,$zip,$cname,$cnumber, $expM,$expY,$vc);

              $stmt->execute();
                          
                           echo ("<script LANGUAGE='JavaScript'>
                window.alert('Succesfully added!!!');
                window.location.href='TpaySucess.php';
                </script>");
    ...
    <form method="POST">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    <span>Accepted method:</span>
                    <img src="image/Card.png" alt="">
                </div>
                <div class="inputBox">
                    <span>Name on method :</span>
