...
<html>
<title>Online Train Ticket System</title>
...
<body > 
          ...
          <div class="usern"><b><font color="#fff"> Hello !!! <?php echo $user_data['username'];?></font></b></div>
            <div class="wrapper">
              <div class="left">
                  <img src="image/a.png"alt="user" width="200">
                  <button class="btn4">Upload image </button><br>
                  <br>
                  <a href="TuserviewTrain.php"><button class="btn4">Home </button></a>
              </div>
              </div>
...
<!--information-->
        <div class="right">
           ...
           <h3>Account Information</h3><hr/><br/>  
                ...
                <br><a href="TupdateProfile.php?id=<?php echo $user_data['id'];?>">
                <button class="btn3">Update</button></a>
                <a href="Tuserlogout.php">
                <button class="btn3">Logout</button></a>
                <a href="TdeleteProfile.php?id=<?php echo $user_data['id'];?>">
