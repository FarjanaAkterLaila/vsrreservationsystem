     ...
     $cost=$_POST['cost'];
       ...
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt=$conn->prepare("INSERT INTO route(via_city,destination,bus_name,departure_date,departure_time,seat,cost) VALUES(?,?,?,?,?,?,?)");
              //table3 is the table name//

              $stmt->bind_param("ssssssi",$via_city,$destination,$bus_name,$dep_date, $dep_time,$seat,$cost);
